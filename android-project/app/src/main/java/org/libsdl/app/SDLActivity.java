...
*/
                ...
                if (Build.VERSION.SDK_INT >= 19 /* Android 4.4 (KITKAT) */) {
                    if (context instanceof Activity) {
                        ...
                        if (window != null) {
                            ...
                            ((SDLActivity) context).applySHARFullscreen();
                            } else {
    ...
    private void applySHARFullscreen() {
    ...
    /*
     * Allow drawing into notch/cutout areas on Android 9+.
     */
    if (Build.VERSION.SDK_INT >= 28 /* Android 9 Pie */) {
    ...
    /*
     * Android 11+ modern immersive fullscreen path.
     */
    ...
    /*
     * Legacy immersive sticky path.
     * We keep this even on newer Android versions because it is harmless and
     * helps some OEM implementations keep the decor flags consistent.
     */
    if (Build.VERSION.SDK_INT >= 19 /* Android 4.4 KitKat */) {
